...
NSString *const kTXNavigatorParameterUserInfo = @"kTXNavigatorParameterUserInfo";

@implementation UIWindow (TXNavigator)
...
@implementation UIViewController (TXRouter)
